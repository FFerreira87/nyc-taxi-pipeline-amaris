...
def transform_silver():
    ...
    # 1. Limpeza e Filtros (Qualidade de Dados)
    ...
    # 2. Join com Zone Lookup (Enriquecimento)
    ...
    # Salvamos em Parquet, podendo particionar por data de pickup para performance futura
